				...
				<div class="roberto-contact-form mb-50">
					<form method="get" id="searchFrm">
						<div class="col-12 wow fadeInUp form-inline form-group"
							...
							<div class="col-lg-3">
								<button type="button" class="btn roberto-btn" id="searchBtn"
									onclick="openSearchWindow();">책 검색</button>
							</div>
						</div>
					</form>
				</div>
			...
			<div class="col-12 col-lg-12">
				...
				<div class="single-room-details-area mb-50 wow fadeInUp">
					...
					<form th:action method="post" id="enrollFrm">
						...
						<hr class="my-2">
						<div
							class="single-blog-post d-flex align-items-center mt-5 mb-50 wow fadeInUp"
							data-wow-delay="100ms">
							<img
								src="${pageContext.request.contextPath}/resources/img/book-photo.png"
								class="d-block w-40 mx-5" alt="" id="cover">
						...
						<div class="room-features-area d-flex flex-wrap mb-50 ">
									...
									<td>
										<div class="form-inline form-group">
											<input type="number" class="form-control"
												placeholder="희망 대여료를 입력하세요" id="price" name="price" min="1"
												step="500"
												onKeyup="this.value=this.value.replace(/[^0-9]/g,'500');"
							...
							<div class="col-12 mt-30 p-0">
								<button type="button" class="btn roberto-btn" id="enrollBtn"
									onclick="enrollBooking();">요청 등록</button>
							</div>
						</div>
						<input type="hidden" name="isbn" value=""> <input
