    ...
    <div class="containe-fluid">
        <div class="row">
            ...
            <div class="col-9">
                    ...
                    <tbody>
                        <c:forEach items="${list}" var="booking" varStatus="status">
                            <tr onclick="location.href='${pageContext.request.contextPath}/booking/bookingDetail.do?bno=${booking.boardNo}'" style="cursor:pointer;">
								...
								<td class="align-middle">${booking.writer}</td>
								<td class="align-middle">${booking.bookReservation.status}</td>
                            </tr>
                ...
                <form id='actionForm' action="${pageContext.request.contextPath}/booking/borrowedList.do" method="get"> 
