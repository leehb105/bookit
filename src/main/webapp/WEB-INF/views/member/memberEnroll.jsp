			      ...
			      <div class="myform form">
                        ...
                        <form:form
	                   	...
	                   	<div> 
							...
							<div class="form-group">
								...
								<input type='button' onclick="generateMap(false, 'addr')" class='btn roberto-btn w-100 mt-2' value="검색">
							</div>

							<div id="map_wrapper">
								검색 위치
								<hr class="my-2">
								<div id="map" style="border: 3px #1cc3b2 solid;"></div>
							</div>
	                    ...
	                    <!-- 끝  -->
                           ...
                           <div class="col-md-12 text-center mb-3">
							<hr>
                              <button type="submit" class="btn roberto-btn w-100 mt-5">가입하기</button>
                           </div>
                           <div class="col-md-12 ">
                              <div class="form-group">
...
$("#email").keyup(function() {
	...
	if (!emailRegExp.test(email)) {
		...
		$.ajax({
			url: `${pageContext.request.contextPath}/member/checkDuplicateEmail.do`,
			type: "GET",
			data: {
				email : email
			},
			...
			success: function(data){
				if(data == 0) {
					emailHelp.innerText = "사용가능한 이메일입니다.";
					advice.css({"color": "blue", "font-size": "12px"});
					return true;
				} 
				else {
					emailHelp.innerText = "사용중인 이메일입니다.";
					advice.css({"color": "red", "font-size": "12px"});
					return false;
				}
			},
...
$("#phone").keyup(function() {
	...
	if (!phoneRegExp.test(phone)) {
		...
		$.ajax({
			url: `${pageContext.request.contextPath}/member/checkDuplicatePhone.do`,
			type: "GET",
			data: {
				phone : phone
			},
			...
			success: function(data){
				if(data == 0) {
					phoneHelp.innerText = "사용가능한 번호입니다.";
					advice.css({"color": "blue", "font-size": "12px"});
					return true;
				} 
				else {
					phoneHelp.innerText = "사용중인 번호입니다.";
					advice.css({"color": "red", "font-size": "12px"});
					return false;
				}
			},
